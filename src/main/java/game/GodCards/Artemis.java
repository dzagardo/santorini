...
//
///**
// Your Worker may move one additional time, but not back to its initial space. (UI hint: You will
// likely need a way to indicate that the player wants to skip the optional second move, either with a
// "pass" button or by clicking on the worker's current location)
//*/
