...
//
///**
// Your Worker may build a dome at any level. (UI hint: you can implement this in the user
// interface similar to Hephaestus, giving the player an second optional build action; this build action is
// interpreted as building a dome)
// */
