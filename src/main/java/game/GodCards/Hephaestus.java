...
//
///**
// Your Worker may build one additional block (not dome) on top of your first block. (UI
// hint: You will likely need a way to indicate that the player wants to skip the optional second build, e.g.,
// with a "pass" button or by clicking on the worker's current location)
// */
