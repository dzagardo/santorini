...
//
///**
// If your Workers do not move up or down, they may each move any number of times (even
// zero), and then either builds. (UI hint: Rather than allowing multiple move actions, it might be easier
// to indicate all possible target spaces where a worker can move too)
// */
//public class Hermes implements GodCard {
//
